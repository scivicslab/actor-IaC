...
/**
 * IIAR wrapper for {@link WorkflowNameSection}.
 *
...
public class WorkflowNameSectionIIAR extends IIActorRef<WorkflowNameSection> {
    ...
    private static final Logger logger = Logger.getLogger(WorkflowNameSectionIIAR.class.getName());
     ...
     */
    public WorkflowNameSectionIIAR(String actorName, IIActorSystem system) {
        super(actorName, new WorkflowNameSection(), system);
    ...
    private void initializeFromWorkflow() {
        ...
        String name = readNameFromYaml(workflowPath);
        if (name != null) {
            object.setWorkflowName(name);
        }
    }
    ...
    private String readNameFromYaml(String workflowPath) {
        try {
            ...
            logger.warning("WorkflowNameSectionIIAR: Could not read workflow file: " + e.getMessage());
        }
        return null;
    }
